...
const Menu = () => {
    ...
    const eraseOrbits = useOrbitStore((state) => state.eraseOrbits)
    ...
    return (
        ...
        >
            ...
            <MenuItem><FaTrash onClick={() => eraseOrbits()} size={28} className="text-white-100 outline-white-500/30"/></MenuItem>
...
const MenuItem = ({children}: {children: React.ReactNode}) => {
    return (
        <motion.div
            ...
            className="h-8 w-8 mb-2 outline outline-1 outline-white-500/30 hover:bg-blue-500 hover:cursor-pointer flex items-center justify-center opacity-85 bg-black-700 z-10 backdrop-blur-md rounded-lg"
        >
            {children}
        </motion.div>
    )
